...
for ((i="$1"; i<401;))
do
PTH="results-hmdb51-mars-split3/HMDB51/MARS_HMDB51_3_train_batch10_sample112_clip64_lr0.0001_nesterovFalse_manualseed1_modelresnext101_ftbeginidx4_layeravgpool_alpha50.0_$i.pth"
if [ ! -f $PTH ];then
    ...
    if [ $(($PTHsize+500)) -gt $filesize ];then
        ...
        --log 0 --dataset HMDB51 --modality RGB --sample_duration 64 --split 3 --only_RGB  \
        --resume_path1 $PTH \
        --frame_dir "dataset/HMDB51_MARS" \
        --annotation_path "dataset/HMDB51_labels" \
        --result_path "results/" >> test-finetuning-mars-hmdb51-split3_from-$1.log
        i=$(($i+$3))
    else
