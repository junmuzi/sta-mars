...
for ((i="$1"; i<400;))
do
PTH="results-hmdb51-mars-split1-based-staflow/HMDB51/MARS_HMDB51_1_train_batch32_sample112_clip64_lr0.0001_nesterovFalse_manualseed1_modelresnext101_ftbeginidx4_layeravgpool_alpha50.0_$i.pth"
if [ ! -f $PTH ];then
    ...
    if [ $(($PTHsize+50)) -gt $filesize ];then
        ...
        --result_path "results/" >> test-finetuning-mars-hmdb51-split1-based-staflow_from-$1.log
        i=$(($i+2))
    else
