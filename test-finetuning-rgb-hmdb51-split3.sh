...
for ((i="$1"; i<401;))
do
PTH="results-hmdb51-rgb-split3/HMDB51/PreKin_HMDB51_3_RGB_train_batch16_sample112_clip64_nestFalse_damp0.9_weight_decay1e-05_manualseed1_modelresnext101_ftbeginidx4_varLR$i.pth"
if [ ! -f $PTH ];then
    ...
    if [ $(($PTHsize+500)) -gt $filesize ];then
        ...
        --result_path "results/" >> test-finetuning-rgb-hmdb51-split3_from-$1.log
        i=$(($i+$3))
    else
